...
class MpiSintel(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='/raid/workspace/andreim/of_datasets/Sintel', dstype='clean',
...
class FlyingChairs(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='/raid/workspace/andreim/of_datasets/FlyingChairs_release/data'):
        ...
        split_list = np.loadtxt('/raid/workspace/andreim/of_datasets/FlyingChairs_release/FlyingChairs_train_val.txt', dtype=np.int32)
...
class FlyingThings3D(FlowDataset):
    def __init__(self, aug_params=None, root='/raid/workspace/andreim/of_datasets/FlyingThings3D', split='training', dstype='frames_cleanpass'):
...
class KITTI(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='/raid/workspace/andreim/of_datasets/KITTI'):
...
class HD1K(FlowDataset):
    def __init__(self, aug_params=None, root='/raid/workspace/andreim/of_datasets/HD1k'):
